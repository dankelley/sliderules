...
# from 01.R, the m2 resultrs:
#  (Intercept)            CT       I(CT^2)            SA
# -25.601568824   0.073966713   0.004663958   0.730313712
A2a <- function(SA) { # SA -> term in spiciness formula
    0.730313712 * SA
}
C2c <- function(CT) { # CT -> term in spiciness formula (includes intercept)
    -25.601568824 + CT * (0.0739667132 + CT * 0.004663958)
}
...
if (!interactive()) {
    png("04.png", unit = "in", width = 7, height = 7, res = 500, pointsize = 10)
}
par(mar = c(4, 3, 2, 3))
