## Instructions: cut along the red circle; place this above sigma_theta_circular_1_lower.pdf
library(oce)
debug <- 0
lower <- FALSE
load("00.rda")
...
if (!interactive()) pdf("sigma_theta_circular_1_upper.pdf", width=7, height=7, pointsize=8)
